(function(){
  ...
  QUnit.test( "Our First Test", function( assert ) {  // QUnit is an object
  ...
  QUnit.test("Functions can access outer scope.", function(assert){
    ...
    function yay(){
      ...
      outside_the_function = inside_the_function; // doesn't actually happen until line 20 when function is called
    }
